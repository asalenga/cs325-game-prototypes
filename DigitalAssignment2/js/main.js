...
window.onload = function() {
    ...
    function endGame (enemy) {
        ...
        var extraComment = game.add.text(game.world.width - 50, game.world.height - 50, 'I hope you had fun playing.\nI had sO mUch fUN cOdINg it. 🙃', { fontSize: '5px', fill: '#FFFFFF' });
