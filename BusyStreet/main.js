...
window.onload = function() {
    ...
    var game = new Phaser.Game( 1000, 800, Phaser.AUTO, 'BusyStreet/main.js', { preload: preload, create: create, update: update } );
    
    function preload() {
        // Load an image and call it 'finn'.
        game.load.image('finn', '../assets/pixel_finn.png' );
        ...
        game.load.image('hazard', '../assets/phaser.jpg');
