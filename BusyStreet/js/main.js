...
window.onload = function() {
    ...
    function preload() {
        ...
        game.load.image('finn', 'assets/pixel-finn' );
        ...
        game.load.image('endzone', 'assets/beach');
    }
