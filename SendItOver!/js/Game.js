 ...
 //   	this.game.physics.arcade.moveToObject(this.redEnemy1, this.player1, 25);
        ...
        if (this.p1currItemTemp != null) {
        	if (this.p1currItemTemp.color == "red") {
        		this.hitGate = this.game.physics.arcade.collide(this.p1currItemTemp, [this.yellowGate,this.greenGate,this.blueGate]);
        	}
        	else if (this.p1currItemTemp.color == "yellow") {
        		this.hitGate = this.game.physics.arcade.collide(this.p1currItemTemp, [this.redGate,this.greenGate,this.blueGate]);
        	}
        	else if (this.p1currItemTemp.color == "green") {
        		this.hitGate = this.game.physics.arcade.collide(this.p1currItemTemp, [this.redGate,this.yellowGate,this.blueGate]);
        	}
        	else if (this.p1currItemTemp.color == "blue") {
        		this.hitGate = this.game.physics.arcade.collide(this.p1currItemTemp, [this.redGate,this.yellowGate,this.greenGate]);
        	}
    	}
		if (this.p2currItemTemp != null) {
        	if (this.p2currItemTemp.color == "red") {
        		this.hitGate = this.game.physics.arcade.collide(this.p2currItemTemp, [this.yellowGate,this.greenGate,this.blueGate]);
        	}
        	else if (this.p2currItemTemp.color == "yellow") {
        		this.hitGate = this.game.physics.arcade.collide(this.p2currItemTemp, [this.redGate,this.greenGate,this.blueGate]);
        	}
        	else if (this.p2currItemTemp.color == "green") {
        		this.hitGate = this.game.physics.arcade.collide(this.p2currItemTemp, [this.redGate,this.yellowGate,this.blueGate]);
        	}
        	else if (this.p2currItemTemp.color == "blue") {
        		this.hitGate = this.game.physics.arcade.collide(this.p2currItemTemp, [this.redGate,this.yellowGate,this.greenGate]);
        	}
    	}
